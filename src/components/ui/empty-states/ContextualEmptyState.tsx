  ...
  return (
    ...
    >
      <div className="absolute inset-0 blur-3xl">
        <div className="h-full w-full rounded-full bg-gradient-to-br from-primary/20 via-transparent to-secondary/20" />
      </div>
      <motion.div
        animate={{ y: [0, -8, 0] }}
    ...
    >
      ...
      {showHelp && config.helpText && !compact && (
        <motion.p
          ...
          className="mt-6 flex items-center gap-1 text-xs text-muted-foreground/60"
        >
