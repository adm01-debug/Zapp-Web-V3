...
import { ImapAccountsSettings } from '@/components/settings/ImapAccountsSettings';
          ...
          <div className="group relative">
            ...
            >
              <TabsList className="inline-flex w-max gap-1 bg-muted/50 p-1">
                ...
                <TabsTrigger value="email-accounts" className="gap-2 whitespace-nowrap">
                  <Users className="h-4 w-4" />
                  Contas
                </TabsTrigger>
                <TabsTrigger value="email-templates" className="gap-2 whitespace-nowrap">
                  <Mail className="h-4 w-4" />
                  Templates
                </TabsTrigger>
