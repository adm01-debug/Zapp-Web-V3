...
import { useOmnichannelChannels, type ChannelType } from '@/hooks/omnichannel/useOmnichannelChannels';
const ChannelRoutingRules = lazy(() => import('./ChannelRoutingRules').then(m => ({ default: m.ChannelRoutingRules })));

const channelConfig: Record<ChannelType, { label: string; icon: typeof MessageSquare; color: string; bg: string }> = {
            ...
            <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
              ...
              <DialogContent>
                ...
                <div className="space-y-4">
                  ...
                  <Button 
                    className="w-full" 
                    onClick={() => addChannel.mutate(newChannel, { onSuccess: () => { setShowAddDialog(false); setNewChannel({ name: '', channel_type: 'instagram' }); } })}
