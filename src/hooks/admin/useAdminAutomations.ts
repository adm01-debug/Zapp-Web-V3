...
export function useAdminAutomations() {
  ...
  const save = async (editing: Rule | null): Promise<boolean> => {
    ...
    const payload = {
      ...
      trigger_config: editing.trigger_config as unknown as import('@/integrations/supabase/types').Json,
      actions: editing.actions as unknown as import('@/integrations/supabase/types').Json,
