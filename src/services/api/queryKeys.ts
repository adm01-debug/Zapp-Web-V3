...
export const queryKeys = {
  ...
  sla: {
    ...
    history: (period?: string, startDate?: string) => ['sla-history', period, startDate] as const,
  ...
  adminOps: {
    ...
    notificationChannels: () => ['notification-channels-config'] as const,
    notificationTemplates: () => ['notification-templates-config'] as const,
    sicoobOutbox: () => [...queryKeys.admin.all(), 'sicoob-outbox-state'] as const,
