...
export const useUpdateWhatsAppConnection = () => {
  return useUpdateMutation(
    ...
    {
      invalidateKeys: [queryKeys.connections.lists(), queryKeys.connections.details()],
...
export const useDeleteWhatsAppConnection = () => {
  return useDeleteMutation((id: string) => connectionsService.deleteWhatsAppConnection(id), {
    invalidateKey: queryKeys.connections.lists(),
