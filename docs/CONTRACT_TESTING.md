...
| `_shared/__tests__/contract-field-matrix.test.ts` | Consome `adversarial-matrix.ts` para os 127 contrato@versão não-multipart: 1581+ casos gerados e testados, gate "no silent caps" sobre wrong_type/explicit_null omitidos. |
