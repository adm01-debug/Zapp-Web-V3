...
Execução: 2026-07-12T20:55:12.756Z
...
|---|---|
| `no-fast-fail-on-auth-error` | 63 |
| `no-explicit-backoff-on-429` | 63 |
| `no-circuit-breaker-on-config-failure` | 63 |
| `missing-message-id-ack` | 63 |
...
| `http_502` | 63 | 0 | 1260 | 0 |
| `timeout` | 63 | 0 | 1260 | 0 |
| `network` | 63 | 0 | 1260 | 0 |
| `invalid_number` | 63 | 0 | 1260 | 0 |
| `flaky` | 63 | 840 | 420 | 1.33 |
| `vault_missing` | 63 | 0 | 1260 | 0 |
| `duplicate_ack` | 63 | 1260 | 0 | 1 |
...
|---|---|---|---|---|---|---|---|---|
| S10 | text | http_401 | 1 | 5 | 1 | 0 | 20 | no-fast-fail-on-auth-error |
| S11 | text | http_401 | 1 | 10 | 1 | 0 | 20 | no-fast-fail-on-auth-error |
| S12 | text | http_401 | 1 | 25 | 1 | 0 | 20 | no-fast-fail-on-auth-error |
| S13 | text | http_401 | 3 | 5 | 1 | 0 | 20 | no-fast-fail-on-auth-error |
| S14 | text | http_401 | 3 | 10 | 1 | 0 | 20 | no-fast-fail-on-auth-error |
| S15 | text | http_401 | 3 | 25 | 1 | 0 | 20 | no-fast-fail-on-auth-error |
| S16 | text | http_401 | 5 | 5 | 1 | 0 | 20 | no-fast-fail-on-auth-error |
| S17 | text | http_401 | 5 | 10 | 1 | 0 | 20 | no-fast-fail-on-auth-error |
| S18 | text | http_401 | 5 | 25 | 1 | 0 | 20 | no-fast-fail-on-auth-error |
