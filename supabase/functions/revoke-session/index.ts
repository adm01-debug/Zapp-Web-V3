 ...
 *
 * NOTE (2026-08-19): este arquivo chegou à main com resíduos de merge não
 * resolvido (PR #1271) — imports duplicados + código morto dentro do catch +
 * segundo catch órfão (TS1005/TS2300, Gate 6 vermelho). Limpeza cirúrgica
 * mantendo a versão documentada (cliente com JWT do caller).
 */
