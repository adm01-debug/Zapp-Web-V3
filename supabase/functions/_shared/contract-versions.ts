...
export const CONTRACTS: Record<string, ContractSpec> = {
  ...
  "elevenlabs-agent-token":       { current: "v1", supported: ["v1"] },
  ...
  "outlook-oauth":                { current: "v1", supported: ["v1"] },
