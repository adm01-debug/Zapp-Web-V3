...
DROP POLICY IF EXISTS "Users can insert SLA history" ON public.sla_history;
...
DROP POLICY IF EXISTS "Users can update SLA history" ON public.sla_history;
...
DROP POLICY IF EXISTS "Users can update their own receipts" ON public.team_message_receipts;
...
DROP POLICY IF EXISTS "Authenticated users can insert gmail health logs" ON public.gmail_health_logs;
