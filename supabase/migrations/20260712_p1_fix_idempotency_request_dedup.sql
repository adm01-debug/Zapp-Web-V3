...
-- Addresses duplicate requests (network retries) creating duplicate tags/notifications
--
-- Problem: Retried requests (network timeout, client retry) create duplicate tags
